...
public:
  ...
  /**
    Constructs a projective point, initializes its coordinates and normalize
    them.
...
inline auto ProjectivePoint::get_coordinates(void) const
    -> const FieldVector & {
  return coordinates_;
}
